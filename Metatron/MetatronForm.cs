...
namespace Metatron
{
    public partial class MetatronForm : Form
    {
        ...
        private void LoadConfigurationValues()
        {
            ...
            textBoxMinimumCorpsAlliancesStanding.Text = config.SocialConfig.MinimumCorpsAlliancesStanding.ToString();
            ...
            checkBoxRunOnCorpsAlliances.Checked = config.DefenseConfig.RunOnCorpsAlliances;
            checkBoxRunOnNegativeFailsafe.Checked = config.DefenseConfig.RunOnNegativeFailsafe;
            ...
            checkBoxUseAnchorWreckOrbiting.Checked = config.RattingConfig.UseAnchorWreckOrbiting;
        ...
        private void checkBoxRunOnCorpsAlliances_CheckedChanged(object sender, EventArgs e)
        {
            Core.Metatron.Config.DefenseConfig.RunOnCorpsAlliances = ((CheckBox)sender).Checked;
        }

        private void checkBoxRunOnNegativeFailsafe_CheckedChanged(object sender, EventArgs e)
        {
            Core.Metatron.Config.DefenseConfig.RunOnNegativeFailsafe = ((CheckBox)sender).Checked;
        }

        private void textBoxMinimumCorpsAlliancesStanding_TextChanged(object sender, EventArgs e)
        {
            int value;
            if (int.TryParse(((TextBox)sender).Text, out value))
            {
                Core.Metatron.Config.SocialConfig.MinimumCorpsAlliancesStanding = value;
            }
        }
        ...
        private void checkBoxUseAnchorWreckOrbiting_CheckedChanged(object sender, EventArgs e)
        {
            Core.Metatron.Config.RattingConfig.UseAnchorWreckOrbiting = ((CheckBox)sender).Checked;
        }
        #endregion
