...
namespace Metatron.Core
{
    internal sealed class Metatron : ModuleBase, IDisposable
    {
		...
		public override bool Initialize()
        {
			...
			NonOffensive = new NonOffensive(MeCache, Config.MiningConfig, Config.DefenseConfig, EntityProvider, TargetQueue, Ship, Drones, Targeting, Movement, Config.SalvageConfig);
