...
namespace Metatron.Core.Config
{
    public interface ISalvageConfiguration : IConfigurationBase
    {
        ...
        bool DistributeSalvagers { get; set; }
    }
    ...
    public sealed class SalvageConfiguration : ConfigurationBase, ISalvageConfiguration
    {
        private static readonly string CreateSalvageBookmarksTag = "Salvage_EnableBM",
                                       ...
                                       DistributeSalvagersTag = "Salvage_DistributeSalvagers";
        #region Salvaging
        ...
        public bool DistributeSalvagers
        {
            get { return GetConfigValue<bool>(DistributeSalvagersTag); }
            set { SetConfigValue(DistributeSalvagersTag, value); }
        }
        #endregion
        ...
        public override void AddDefaultConfigProperties()
        {
            ...
            AddDefaultConfigProperty(new ConfigProperty<bool>(DistributeSalvagersTag, true));
        }
    }
}
