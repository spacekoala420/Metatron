...
namespace Metatron.Core.Config
{
    public sealed class DefensiveConfiguration : ConfigurationBase, IDefensiveConfiguration
    {
        static readonly string MINIMUM_SHIELD_PCT = "Defense_MinimumShieldPct",
                               ...
                               RUN_ON_CORPS_ALLIANCES = "Defense_RunOnCorpsAlliances",
                               RUN_ON_NEGATIVE_FAILSAFE = "Defense_RunOnNegativeFailsafe",
        ...
        public bool RunOnCorpsAlliances
        {
            get { return GetConfigValue<bool>(RUN_ON_CORPS_ALLIANCES); }
            set { SetConfigValue(RUN_ON_CORPS_ALLIANCES, value); }
        }
        public bool RunOnNegativeFailsafe
        {
            get { return GetConfigValue<bool>(RUN_ON_NEGATIVE_FAILSAFE); }
            set { SetConfigValue(RUN_ON_NEGATIVE_FAILSAFE, value); }
        }
        ...
        public override void AddDefaultConfigProperties()
        {
            ...
            AddDefaultConfigProperty(new ConfigProperty<bool>(RUN_ON_CORPS_ALLIANCES, false));
            AddDefaultConfigProperty(new ConfigProperty<bool>(RUN_ON_NEGATIVE_FAILSAFE, false));
