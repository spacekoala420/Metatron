...
namespace Metatron.Core.Config
{
    public interface IRattingConfiguration : IConfigurationBase
    {
        ...
        bool UseAnchorWreckOrbiting { get; set; }
    }
    ...
    public sealed class RattingConfiguration : ConfigurationBase, IRattingConfiguration
    {
        private static readonly string CHAIN_BELTS = "Ratting_ChainBelts",
                                       ...
                                       USE_ANCHOR_WRECK_ORBITING = "Ratting_UseAnchorWreckOrbiting";
        ...
        public bool UseAnchorWreckOrbiting
        {
            get { return GetConfigValue<bool>(USE_ANCHOR_WRECK_ORBITING); }
            set { SetConfigValue(USE_ANCHOR_WRECK_ORBITING, value); }
        }
        ...
        public override void AddDefaultConfigProperties()
        {
            ...
            AddDefaultConfigProperty(new ConfigProperty<bool>(USE_ANCHOR_WRECK_ORBITING, false)); // OFF by default - users must enable
