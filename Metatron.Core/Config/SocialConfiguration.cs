...
namespace Metatron.Core.Config
{
    public sealed class SocialConfiguration : ConfigurationBase
    {
        static readonly string MINIMUM_PILOT_STANDING = "Social_MinimumPilotStanding",
                               ...
                               MINIMUM_CORPS_ALLIANCES_STANDING = "Social_MinimumCorpsAlliancesStanding",
        ...
        public int MinimumCorpsAlliancesStanding
        {
            get { return GetConfigValue<int>(MINIMUM_CORPS_ALLIANCES_STANDING); }
            set { SetConfigValue(MINIMUM_CORPS_ALLIANCES_STANDING, value); }
        }
        ...
        public override void AddDefaultConfigProperties()
        {
            ...
            AddDefaultConfigProperty(new ConfigProperty<int>(MINIMUM_CORPS_ALLIANCES_STANDING, 0));
